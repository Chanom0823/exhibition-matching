    ...
    <div className="w-full max-w-[2270.4px] md:max-w-7xl mx-auto h-16 md:h-20 flex justify-between items-center px-4 md:px-8 lg:px-12 py-2.5">
      ...
      <div className="flex items-center gap-2  md:gap-4">
        ...
        {!['/usermatching', '/user-panel', '/login'].includes(pathName || '') && (
          <Link
            href="/login"
            className="bg-gray-800 text-white rounded-lg w-[30px] h-[35px] md:w-[100px] md:h-[40px] text-sm md:text-base flex items-center justify-center hover:bg-gray-700 transition"
          >
            {t.loginCta}
          </Link>
        )}
